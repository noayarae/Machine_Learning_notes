...
ds <- read.csv('006_site_features_clean_t1.csv')
ds <- read.csv('006_site_features_clean_t3.csv')
...
#library(corrplot)
ncol(dat)
#datamatrix <- cor(dat[,c(-13)]) # Remove the last variable (response var)
datamatrix <- cor(dat[,c(-ncol(dat))]) # Remove the last variable (response var)
